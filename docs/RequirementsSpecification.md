...
| **対応環境** | Chrome、Safari、Edgeなどの主要ブラウザの最新版で利用できることを想定している。通勤時間や寝る前の隙間時間に手軽に使えることを重視し、スマホ・タブレットでの利用を主に想定する（パソコンでの利用はそれに次ぐ扱い）。専用のスマホアプリは用意せず、ブラウザで画面幅に合わせて見やすくなるようにする |
